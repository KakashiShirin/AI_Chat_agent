#!/usr/bin/env python3
"""
Reset and Import Script for Cordly AI - Olist E-commerce Dataset
This script clears existing data and imports CSV files into PostgreSQL database
"""
...
def import_csv_to_table(conn, csv_file_path, table_name):
    ...
    try:
        ...
        # Handle NaN values - use None for proper NULL handling
        df = df.replace('', None)
