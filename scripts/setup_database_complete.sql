-- Complete Database Setup Script for Cordly AI - Olist E-commerce Dataset
-- This script creates the database and all tables

-- Create database (run this as postgres superuser)
-- CREATE DATABASE cordly_ai;

-- Connect to the cordly_ai database and create tables
-- Note: You need to connect to cordly_ai database first, then run the rest
