#!/usr/bin/env python3
"""
Robust Data Import Script for Cordly AI - Olist E-commerce Dataset
This script handles data type issues and imports CSV files into PostgreSQL database
"""
...
def clean_dataframe(df, table_name):
    ...
    if table_name == 'olist_products_dataset':
            # Convert float columns to int, handling NaN values
            numeric_columns = [
